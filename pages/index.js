...
export default function Home() {
  ...
  <div className="absolute inset-0 bg-gradient-to-t from-blue-700 via-transparent to-transparent opacity-80"></div>
  <div className="relative z-10 max-w-7xl mx-auto flex items-center justify-center h-full text-center text-white px-4 sm:px-6 lg:px-8">
    <div>
      ...
      <p className="mt-4 text-lg sm:text-xl">
        Centro de Rehabilitación especializado en la recuperación de <br className="hidden lg:block" />
        adicciones. Estamos aquí para ayudarte a comenzar una nueva vida.
      </p>
      ...
      <div className="flex flex-col sm:flex-row sm:justify-center gap-4 sm:gap-4 mt-6">
        ...
        <a
          href="/contacto"
          className="w-56 mx-auto sm:w-auto inline-block bg-green-500 text-black py-3 px-8 rounded-full text-lg hover:bg-yellow-400 transition duration-300 transform hover:scale-105"
        >
          Línea de Ayuda
        </a>
        ...
        <a
          href="/contacto"
          className="w-56 mx-auto sm:w-auto inline-block bg-yellow-400 text-black py-3 px-8 rounded-full text-lg hover:bg-green-500 transition duration-300 transform hover:scale-105"
        >
          Más Información
        </a>
      </div>
